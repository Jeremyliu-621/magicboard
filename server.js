...
const requestHandler = async (req, res) => {
  ...
  // CORS: the game page can be served from the Mac's LAN IP (so the phone QR works) while it talks
  // to /healthz / the relay — a different origin. Allow it (local dev/demo server).
