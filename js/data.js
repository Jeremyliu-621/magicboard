...
(function (global) {
  ...
  function defaults() {
    return {
      ...
      characters: {
        // built-in fighters start with NO drawn skin — the Draw tab opens to a blank canvas, and
        // they fall back to the built-in stick figure in-game until you draw one.
        // (BEAR_SKIN above is an optional preset — pass it as the 4th arg to use the bear.)
        Sprout: makeCharacter('Sprout', 'none', '#5b8c5a'),
        Acorn: makeCharacter('Acorn', 'none', '#9c6b3f'),
      },
      roster: ['Sprout', 'Acorn'],
    };
  }
  ...
  // v16: bear offsetY 14 (feet on the ground).
  // v17: restore the default stage platforms (the AI/iPad pipeline used to seed them; now baked in).
  // v18: default fighters start with no drawn skin (blank Draw canvas; stick-figure fallback in-game).
  const KEY = 'doodle-smash:data:v18';
